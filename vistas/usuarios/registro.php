...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="display: flex; justify-content: center; margin-top: 80px">
            ...
            <form method="POST" action="<?php echo ruta . '/registrar' ?>" class="col s12 m7 card" style="margin-left: 0;" >
                ...
                <div class="input-field">
                    ...
                    <input type="number" class="validate" id="txtCedula" name="cedula" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['cedula'] : '') ?>">
                ...
                <div class="input-field">
                    ...
                    <input type="text" class="validate" id="txtNombre" name="nombre" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['nombre'] : '') ?>">
                ...
                <div class="input-field" style="margin-top: 25px;">
                    ...
                    <input type="text" class="validate" id="txtApellido" name="apellido" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['apellido'] : '') ?>">
                ...
                <div class="input-field" style="margin-top: 25px;">
                    ...
                    <input type="email" class="validate" id="txtCorreo" name="correo" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['correo'] : '') ?>">
                ...
                <div class="input-field" style="margin-top: 25px;">
                    ...
                    <input type="password" class="validate" id="txtPassword" name="contrasena" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['contrasena'] : '') ?>">
                ...
                <div class="input-field" style="margin-top: 25px;">
                    ...
                    <input type="text" class="validate" id="txtCiudad" name="ciudad" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['ciudad'] : '') ?>">
                ...
                <div class="input-field" style="margin-top: 25px;">
                    ...
                    <input type="text" class="validate" id="txtDireccion" name="direccion" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['direccion'] : '') ?>">
                ...
                <div class="input-field" style="margin-top: 25px;">
                    ...
                    <input type="number" class="validate" id="txtCelular" name="celular" required
                            value="<?php echo ( ($datosUsuario != null) ? $datosUsuario['celular'] : '') ?>">
