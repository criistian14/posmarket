...
<head>
    ...
    <title>Busqueda <?php echo ucfirst($busqueda) ?></title>
...
<!-- Productos de Busqueda  -->

<h3 class="grey lighten-3 p-3">Productos con la busqueda <span class="deep-orange-text"><?php echo $busqueda ?></span></h3>
